...
set RAM2_CLK { SDRAM2_CLK }
set RAM2_OUT { SDRAM2_nCS SDRAM2_CKE SDRAM2_DQ[*] SDRAM2_A* SDRAM2_DQM* SDRAM2_BA* SDRAM2_nRAS SDRAM2_nCAS SDRAM2_nWE}
set RAM2_IN {SDRAM2_DQ[*]}
